...
class PointGuard(Base):
    ...
    three_point_percentage: Mapped[float] = mapped_column(nullable=True)

    player: Mapped["Player"] = relationship(back_populates="point_guard")

    def __repr__(self) -> str:
        return f"PointGuard(id={self.id!r}, assists_per_game={self.assists_per_game!r}, three_point_percentage={self.three_point_percentage!r})"
