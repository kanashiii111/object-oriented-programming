  ...
  if (typeSelect.value === "center") {
    const centerData = {
      center: {
        ...
        blocks_per_game: parseFloat(
          document.getElementById("blocksPerGame").value,
        ),
        rebounds_per_game: parseFloat(
          document.getElementById("reboundsPerGame").value,
        ),
      },
    };
    ...
    const pointGuardData = {
      point_guard: {
        assists_per_game: parseFloat(
          document.getElementById("assistsPerGame").value,
        ),
        three_point_percentage: parseFloat(
          document.getElementById("threePointPercentage").value,
        ),
      },
    };
